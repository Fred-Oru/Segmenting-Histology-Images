...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python3 glomerulus.py detect --dataset=/path/to/dataset --subset=train --weights=<last or /path/to/weights.h5>
"""
...
class GlomerulusDataset(utils.Dataset):
    ...
    def load_glomerulus(self, dataset_dir, subset):
        ...
        subset: Subset to load. Either one of train, val or test
            * train : all images in train except ids starting with VAL_IMAGE_STARTS_WITH
            * valid : images starting with VAL_IMAGE_STARTS_WITH
            * test : todo
        """
